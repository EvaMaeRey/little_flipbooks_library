...
The code designed to parse and reconstruct code was then tested in small projects and refined.  Then I created a flipbook of a sizable collection of plots that I had coded over about about a year and a half in learning ggplot.  After rewriting this code in a "slow" ggplot style, and providing written description to introduce the plots, I publicized the work in February, 2019; the flipbook was met the an enthusiastic reception.  

Since then, a number changes have been made to the foundational code to improve the tool and to enhance its usefulness. 
