...
---
=======
This is a minimal example to demonstrate how to create a flipbook with data from #TidyTuesday that will walk through data wrangling and plots pipelines made with the Tidyverse.  The functions that make this possible are the work of Emi Tanaka, Garrick Aden-Buie and myself, and are built for Xaringan, an Rmarkdown file type for creating presentation slides; the functions make use of the function `knitr:::knit_code$get()`.
>>>>>>> b9f6f4b45d5bd38bedcdb151e4f3f733620a90d0
...
```{r plot_nobel_again, echo = F, eval = T, fig.height=5}
