...
When awarding seats to parties in proportional representation systems, a dilemma is faced, as the seats available in a representitive body are unlikely to able to be perfectly apportioned --- only if fractions of seats were apportioned would that be possible.   
...
We'll represent the data associated with the parties with colored columns, the hight of which is the "D'hondt outcome". 
...
- t2 shows the resultant "dhont outcomes", grouped by party
- t3 shows the rank among all the "D'hont outcomes"
- t4 will show only the "D'hont outcomes" that are ranked high enough to earn a seat
...
In the opening lines of his 1973 paper, "The Relationship between Seats and Votes in Two-Party Systems", Eduard Tufte makes the observation:
