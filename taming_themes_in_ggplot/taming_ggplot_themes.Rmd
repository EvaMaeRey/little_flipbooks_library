...
Visual Table of Contents - Ryan

<div class = "figure">

<a href="#uglyplot" title = "custom theme" target="_blank" class="set-target">
<img width="23%" height="300" src="figures/custom_theme.png" class="attachment-medium size-medium" alt="" srcset="figures/custom_theme.png 30w, figures/custom_theme.png 150w, figures/custom_theme.png 50w, figures/custom_theme.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>

<a href="#textelements" title = "text components" target="_blank" class="set-target">
<img width="23%" height="300" src="figures/text_components.png" class="attachment-medium size-medium" alt="" srcset="figures/text_components.png 30w, figures/text_components.png 150w, figures/text_components.png 50w, figures/text_components.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>

<a href="#textelements" title = "custom theme" target="_blank" class="set-target">
<img width="23%" height="300" src="figures/custom_theme.png" class="attachment-medium size-medium" alt="" srcset="figures/custom_theme.png 30w, figures/custom_theme.png 150w, figures/custom_theme.png 50w, figures/custom_theme.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>
...
<div class="container">
  <div class="column-center">Column center <div class = "figure">
<img src="figures/custom_theme.png"  href="#uglyplot" title = "custom theme" alt = "hello" width = "75%" />
<p class="caption">custom theme</p>
</div> </div>
...
<div id="gallery-30" class="gallery galleryid-4010 gallery-columns-3 gallery-size-medium"><figure class="gallery-item">
			<div class="gallery-icon landscape">
				<a href="#uglyplot" title = "custom theme" target="_blank" class="set-target">
				<img width="300" height="300" src="figures/custom_theme.png" class="attachment-medium size-medium" alt="" aria-describedby="gallery-30-3267" srcset="figures/custom_theme.png 30w, figures/custom_theme.png 150w, figures/custom_theme.png 50w, figures/custom_theme.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>
			</div>
				<figcaption class="wp-caption-text gallery-caption" id="gallery-30-3267">
				#248 Igraph plotting parameters
				</figcaption></figure><figure class="gallery-item">
			<div class="gallery-icon landscape">
				<a href="http://wp.me/P6CSAh-QE" target="_blank" class="set-target"><img width="300" height="300" src="figures/custom_theme.png" class="attachment-medium size-medium" alt="" aria-describedby="gallery-30-3270" srcset="figures/custom_theme.png 300w, https://www.r-graph-gallery.com/wp-content/uploads/2017/04/248_igraph_custom_features5-150x150.png 150w, https://www.r-graph-gallery.com/wp-content/uploads/2017/04/248_igraph_custom_features5-50x50.png 50w, https://www.r-graph-gallery.com/wp-content/uploads/2017/04/248_igraph_custom_features5.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>
			</div>
				<figcaption class="wp-caption-text gallery-caption" id="gallery-30-3270">
				#248 Igraph plotting parameters
				</figcaption></figure><figure class="gallery-item">
			<div class="gallery-icon landscape">
				<a href="http://wp.me/P6CSAh-QE" target="_blank" class="set-target"><img width="300" height="300" src="https://www.r-graph-gallery.com/wp-content/uploads/2017/04/248_igraph_custom_features4-300x300.png" class="attachment-medium size-medium" alt="" aria-describedby="gallery-30-3269" srcset="figures/custom_theme.png 300w, figures/custom_theme.png 150w, figures/custom_theme.png 50w, figures/custom_theme.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>
			</div>
				<figcaption class="wp-caption-text gallery-caption" id="gallery-30-3269">
				#248 Igraph plotting parameters
				</figcaption></figure><figure class="gallery-item">
			<div class="gallery-icon landscape">
				<a href="http://wp.me/P6CSAh-R2" target="_blank" class="set-target"><img width="300" height="300" src="figures/custom_theme.png" class="attachment-medium size-medium" alt="" aria-describedby="gallery-30-3290" srcset="figures/custom_theme.png 300w, figures/custom_theme.png 150w, figures/custom_theme.png 50w, figures/custom_theme.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>
			</div>
				<figcaption class="wp-caption-text gallery-caption" id="gallery-30-3290">
				#249 Igraph: map a color
				</figcaption></figure><figure class="gallery-item">
			<div class="gallery-icon landscape">
				<a href="http://wp.me/P6CSAh-QD" target="_blank" class="set-target"><img width="300" height="300" src="figures/custom_theme.png" class="attachment-medium size-medium" alt="" aria-describedby="gallery-30-3271" srcset="figures/custom_theme.png 300w, figures/custom_theme.png 150w, figures/custom_theme.png 50w, figures/custom_theme.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>
			</div>
				<figcaption class="wp-caption-text gallery-caption" id="gallery-30-3271">
				#257 Network layouts
				</figcaption></figure><figure class="gallery-item">
			<div class="gallery-icon landscape">
				<a href="http://wp.me/P6CSAh-Rc" target="_blank" class="set-target"><img width="300" height="300" src="figures/custom_theme.png" class="attachment-medium size-medium" alt="" aria-describedby="gallery-30-3300" srcset="figures/custom_theme.png 300w, figures/custom_theme.png 150w, figures/custom_theme.png 50w, figures/custom_theme.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>
			</div>
				<figcaption class="wp-caption-text gallery-caption" id="gallery-30-3300">
				#250 Correlation Network with igraph
				</figcaption></figure><figure class="gallery-item">
			<div class="gallery-icon landscape">
				<a href="http://wp.me/P6CSAh-Rj" target="_blank" class="set-target"><img width="300" height="300" src="figures/custom_theme.png" class="attachment-medium size-medium" alt="" aria-describedby="gallery-30-3306" srcset="figures/custom_theme.png 300w, figures/custom_theme.png 150w, figures/custom_theme.png 50w, figures/custom_theme.png 480w" sizes="(max-width: 300px) 100vw, 300px"></a>
			</div>
				<figcaption class="wp-caption-text gallery-caption" id="gallery-30-3306">
				#251 network with node size relative to number of edges
				</figcaption></figure>
		</div>
...
ggsave("figures/custom_theme.png", dpi = 300)
```
...
```{r, echo = F, warning=F, message=F, eval = T}
ggsave("figures/text_components.png", dpi = 300)
```
